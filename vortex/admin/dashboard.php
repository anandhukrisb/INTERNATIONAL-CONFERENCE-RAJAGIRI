...
<!-- Quick Search Box Banner -->
<div class="section-card" style="background: #eff6ff; border-color: #bfdbfe;">
    <div class="section-body" style="padding: 20px;">
        <h2 style="font-size: 1.1rem; color: #1e40af; margin-bottom: 6px;">🔍 Lookup Details by Vortex ID</h2>
        <p style="font-size: 0.88rem; color: #1e3a8a; margin-bottom: 14px;">
            Quickly search any transaction, customer details, payment processor signatures, and webhooks by entering the Vortex Transaction ID:
        </p>
        <form action="payments/payment_details.php" method="GET" style="display: flex; gap: 10px; max-width: 600px;">
            <input type="text" name="vortex_transaction_id" class="form-control" style="font-family: var(--font-mono); font-size: 0.95rem;" placeholder="e.g. VTX_SIM_123 or VTX_66E3A8..." required>
...
<div id="transactions" class="section-card">
    <div class="section-header">
        ...
        <a href="payments/payment_details.php" class="btn btn-secondary btn-sm">Search / View All</a>
    </div>
...
<!-- API Clients Management Section -->
