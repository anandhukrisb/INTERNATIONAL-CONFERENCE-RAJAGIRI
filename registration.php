...
<body>
    ...
    <div class="sticky-sidebar-buttons">
        <a href="#" class="sidebar-btn" id="registerBtn">Register Now</a>
    </div>
    -->
    ...
    <main class="main-container">
        ...
        <section class="registration-form-section">
            ...
            <div class="wizard-progress">
                ...
                <div class="progress-step active" data-step="1" data-label="1. Registration">1</div>
                <div class="progress-step" data-step="2" data-label="2. Payment Review">2</div>
                <div class="progress-step" data-step="3" data-label="3. Confirmation">3</div>
            </div>

            <!-- STEP 1: REGISTRATION -->
            <div id="step-1" class="step-container active">

                <!-- Abstract Submission Choice -->
                <div class="form-row" style="margin-bottom: 25px;">
                    <div class="form-group">
                        <label for="abstractSubmitted" class="form-label">Have you submitted an abstract for the
                            conference?</label>
                        <select id="abstractSubmitted" class="form-control" onchange="handleAbstractStatusChange()"
                            required>
                            <option value="" disabled selected>Select abstract status...</option>
                            <option value="yes">Yes, I have submitted an abstract</option>
                            <option value="no">No, I have not submitted an abstract</option>
                        </select>
                    </div>
                </div>

                <!-- Email Verification Block (For Submitted Abstract) -->
                <div id="verificationContainer" class="verification-box" style="display: none;">
                    <h4
                        style="font-family: 'Outfit', sans-serif; color: var(--primary-purple); margin-bottom: 12px; font-weight: 700;">
                        Abstract Submitter Verification</h4>
                    <p style="font-size: 0.9rem; color: var(--text-muted); margin-bottom: 15px;">Please enter the email
                        address used for abstract submission to verify and unlock your registration.</p>
                    <div class="verification-row">
                        <div class="form-group" style="margin-bottom: 0;">
                            <label for="verifyEmail" class="form-label">Submission Email Address</label>
                            <input type="email" id="verifyEmail" class="form-control"
                                placeholder="author@icswhmh2027.org">
                        </div>
                        <button type="button" class="btn-verify" id="btnVerify"
                            onclick="verifySubmissionsEmail()">Verify Email</button>
                    </div>
                    <div id="verifyStatus" class="verification-status"></div>
                </div>
                ...
                <form id="registrationForm" onsubmit="submitStep1(event)" class="locked-form-overlay">
                    ...
                    <div class="form-group" style="margin-bottom: 25px;">
                        <label for="dietary" class="form-label">Dietary Requirements / Special Needs</label>
                        <textarea id="dietary" name="dietary" class="form-control" rows="3"
                            placeholder="Please specify any dietary requirements or accessibility needs (if none, write None)..."></textarea>
                    </div>
            ...
            <div id="step-2" class="step-container">
                    ...
                    <div class="invoice-body">
                        ...
                        <div class="receipt-grid">
                            <div class="receipt-item">
                                ...
                                <span class="receipt-value" id="reviewName">Alan Wake</span>
                            </div>
                            <div class="receipt-item">
                                <span class="receipt-label">Email Address</span>
                                <span class="receipt-value" id="reviewEmail">alan.wake@example.com</span>
                            </div>
                            <div class="receipt-item">
                                <span class="receipt-label">Institution / Organization</span>
                                <span class="receipt-value" id="reviewOrganization">University of Excellence</span>
                            </div>
                            <div class="receipt-item">
                                <span class="receipt-label">Phone Number</span>
                                <span class="receipt-value" id="reviewPhone">+91 98765 43210</span>
                            </div>
                            <div class="receipt-item">
                                <span class="receipt-label">Participant Type</span>
                                <span class="receipt-value" id="reviewType">General Registration</span>
                            </div>
                            <div class="receipt-item">
                                <span class="receipt-label">Country Category</span>
                                <span class="receipt-value" id="reviewCountry">Developed Countries</span>
                            </div>
                            <div class="receipt-item" style="grid-column: span 2;">
                                <span class="receipt-label">Selected Requirement</span>
                                <span class="receipt-value" id="reviewRequirement">Early Bird In-Person</span>
                            </div>
                        </div>
                        ...
                        <table class="invoice-table">
                            ...
                            <tbody>
                                <tr>
                                    <td id="invoiceItemDesc">PhD Colloquium - Offline Access Fee</td>
                                    <td style="text-align: right; font-weight: 600;" id="invoiceBasePrice">150 USD</td>
                                </tr>
                                <tr class="gst-row" style="display: none !important;">
                                    <td>Goods & Services Tax (GST) @ 18%</td>
                                    <td style="text-align: right;" id="invoiceGstPrice">27 USD</td>
                                </tr>
                                <tr class="total-row">
                                    <td>Total Amount Due</td>
                                    <td style="text-align: right;" id="invoiceTotalPrice">177 USD</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="btn-container">
                    <button type="button" class="btn-back" onclick="goToStep(1)">Back to Edit</button>
                ...
                <div class="success-celebration">
                    ...
                    <div class="receipt-summary-box">
                        <div class="receipt-row">
                            ...
                            <span id="finalTxnId">TXN-ICSW-2940284</span>
                        </div>
                        <div class="receipt-row">
                            <span>Registrant</span>
                            <span id="finalName">Alan Wake</span>
                        </div>
                        <div class="receipt-row">
                            <span>Registration Category</span>
                            <span id="finalType">PhD Scholar</span>
                        </div>
                        <div class="receipt-row">
                            <span>Country / Tier</span>
                            <span id="finalCountry">Developing Countries</span>
                        </div>
                        <div class="receipt-row">
                            <span>Paid Package</span>
                            <span id="finalRequirement">In-Person (Offline)</span>
                        </div>
                        <div class="receipt-row">
                            <span>Total Paid</span>
                            <span id="finalPricePaid">118 USD</span>
                        </div>
                    </div>
    ...
    <script>
        ...
        // Hardcoded emails for demonstration
        const APPROVED_EMAILS = [
            'author@icswhmh2027.org',
            'author@example.com',
            'speaker@icswhmh2027.org',
            'presenter@icswhmh2027.org'
        ];

        // Handles choice of Abstract Submission Status
        function handleAbstractStatusChange() {
            const status = document.getElementById('abstractSubmitted').value;
            const verifBox = document.getElementById('verificationContainer');
            const form = document.getElementById('registrationForm');
            const emailInput = document.getElementById('email');

            wizardState.abstractSubmitted = status;

            if (status === 'yes') {
                // Show email verification box
                verifBox.style.display = 'block';

                // If not already verified, lock the remaining form
                if (!wizardState.isVerified) {
                ...
                // Unlock form immediately
                form.classList.remove('locked-form-overlay');
                form.classList.add('unlocked-form');

                // Make email input editable
                emailInput.readOnly = false;
                if (wizardState.isVerified) {
                    // Reset verification if they changed to No
                    resetVerification();
                }
            }
        }

        // Mock verify email used in submission
        function verifySubmissionsEmail() {
            const emailVal = document.getElementById('verifyEmail').value.trim().toLowerCase();
            ...
            statusDiv.innerHTML = 'Checking abstract database...';
            ...
            setTimeout(() => {
                ...
                if (APPROVED_EMAILS.includes(emailVal)) {
                    // Success!
                    wizardState.isVerified = true;
                    wizardState.email = emailVal;

                    statusDiv.innerHTML = `
                        <span class="verified-badge">✓ Verified Abstract Submitter</span>
                        <span style="color: #2F855A; margin-left: 10px;">Email successfully matched with submitted abstract!</span>
                    `;
                    statusDiv.className = 'verification-status success';
                    statusDiv.style.color = '#2F855A';

                    // Populate email and make readonly
                    const emailInput = document.getElementById('email');
                    ...
                    // Disable verification block changes
                    ...
                    // Failure
                    statusDiv.innerHTML = '⚠ Email address not found in submitted abstracts database. For testing, try <strong style="margin: 0 4px;">author@icswhmh2027.org</strong>';
                    statusDiv.className = 'verification-status error';
        ...
        // Dynamically updates package options dropdown based on Who they are & Where they are from
        ...
        // Transition between wizard steps smoothly
        ...
        function submitStep1(event) {
            ...
            const status = document.getElementById('abstractSubmitted').value;
            if (status === 'yes' && !wizardState.isVerified) {
                alert('Please verify your abstract submission email first before proceeding.');
                return;
            }
            ...
            if (!firstName || !lastName || !email || !organization || !phone || !pType || !countryVal || !cCat || isNaN(reqIdx)) {
            ...
            // Hide any previous payment error
            ...
            const payload = {
                ...
                dietaryRequirements: document.getElementById('dietary').value.trim() || 'None',
                ...
                gstAmount: wizardState.gstPrice,
                totalAmount: wizardState.totalPrice,
            ...
            .then(data => {
                if (data.success && data.registration_id) {
                    proceedToStep2(data.registration_id, rawCost);
                } else {
                    throw new Error(data.error || 'Failed to save registration details.');
                }
            })
            .catch(error => {
                ...
                proceedToStep2(simulatedId, rawCost);
            })
            .finally(() => {
        ...
        // Mock payment simulator and confirmation trigger
        function completePayment() {
            // Show the BillDesk payment simulator overlay modal
        ...
        // Finalize transaction state and transition screens
        function handleGatewayResponseFinish(status, txnId) {
            ...
            if (status === 'Success') {
                ...
                // Show failure notification in Step 2 review page
                document.getElementById('paymentErrorMessage').textContent = 'Your simulated payment was declined or cancelled. Please verify your details or select another simulated outcome.';
                errorBox.classList.add('active');
                
                // Scroll to top of the form section to make sure the error box is fully visible
                document.querySelector('.registration-form-section').scrollIntoView({ behavior: 'smooth', block: 'start' });
            }
        }
    </script>
